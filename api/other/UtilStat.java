...
public class UtilStat {
    ...
    public static int getLevelAtExperience(int playerExperience) {
        int index;

        for (index = 0; index < EXPERIENCES.length; index++) {
            if (EXPERIENCES[index + 1] > playerExperience)
                break;
        }
